...
- [概述](./manual/user/roles-and-permissions/summary.md)
- [系统角色与权限](./manual/user/user-and-roles.md)
- [账本角色与权限](./manual/user/ledger-role-and-permissions.md)
- [角色与权限的限制](./manual/user/roles-and-permissions/role-permission-limitations.md)
...
- [附录I-复式记账法入门指南](./manual/user/appendix-I.md)
- [附录II-为什么要记账和数字化记账的好处是什么](./manual/user/appendix-II.md)

### 关于框架

- [关于元初框架](./manual/framework/about.md)
